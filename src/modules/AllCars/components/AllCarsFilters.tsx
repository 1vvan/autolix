...
export const AllCarsFilters = ({ filtersData, dropdownsOptions, changeParam, onSaveFilters }) => {
    ...
    return (
        <>
            ...
            <Modal showModal={showModal} setShowModal={setShowModal} title="Cars Filters" onSave={onSave} bodyClassNames={'flex flex-col gap-2 w-96'}>
                <Dropdown value={filtersData.status_id} id="status_id" options={dropdownsOptions.statusOptions} onChange={changeParam} placeholder="Select Status" />
